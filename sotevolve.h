...
#ifndef _OXS_SOTEVOLVE
#define _OXS_SOTEVOLVE
...
/* End includes */
class Oxs_SOTEvolve:public Oxs_TimeEvolver {
private:
  ...
  Oxs_OwnedPointer<Oxs_VectorField> J_init;
  Oxs_OwnedPointer<Oxs_VectorField> mp_init; // Unused in SOT mode

  // Spin Hall SOT parameters
  OC_REAL8m theta_SH;
  OC_REAL8m fm_thickness;
  OC_REAL8m field_like_ratio;
  OC_REAL8m sigma_sign;
  ...
  Oxs_ScalarOutput<Oxs_SOTEvolve> max_dm_dt_output;
  Oxs_ScalarOutput<Oxs_SOTEvolve> dE_dt_output;
  Oxs_ScalarOutput<Oxs_SOTEvolve> delta_E_output;
  Oxs_ScalarOutput<Oxs_SOTEvolve> ave_J_output;
  Oxs_VectorFieldOutput<Oxs_SOTEvolve> dm_dt_output;
  Oxs_VectorFieldOutput<Oxs_SOTEvolve> mxH_output;
  Oxs_VectorFieldOutput<Oxs_SOTEvolve> precession_output;
  Oxs_VectorFieldOutput<Oxs_SOTEvolve> damping_output;
  Oxs_VectorFieldOutput<Oxs_SOTEvolve> dl_sot_output;
  Oxs_VectorFieldOutput<Oxs_SOTEvolve> fl_sot_output;
  Oxs_VectorFieldOutput<Oxs_SOTEvolve> spin_torque_output;
  Oxs_VectorFieldOutput<Oxs_SOTEvolve> Jmp_output;
...
#define RKStepFuncSig(NAME) \
  ...
  RKStepFuncSig((Oxs_SOTEvolve::* rkstep_ptr));
  ...
  Oxs_SOTEvolve(const Oxs_SOTEvolve&);
  Oxs_SOTEvolve& operator=(const Oxs_SOTEvolve&);

public:
  virtual const char* ClassName() const; // ClassName() is
  /// automatically generated by the OXS_EXT_REGISTER macro.
  virtual OC_BOOL Init();
  Oxs_SOTEvolve(const char* name,     // Child instance id
		       Oxs_Director* newdtr, // App director
		       const char* argstr);  // MIF input block parameters
  virtual ~Oxs_SOTEvolve();
